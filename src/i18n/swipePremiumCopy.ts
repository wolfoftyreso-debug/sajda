export const swipePremiumCopy = {
  sv: {
    undo: "Ångra senaste valet", pending: "Kontrollerar åtkomst…", hint: "Ett steg tillbaka · ditt senaste val",
    title: "Ångra ett steg med Premium", description: "Ångra ditt senaste val, oavsett om du valde Hoppa över eller Behåll. Kortet visas igen så att du kan välja på nytt.",
    ...
    verify: "Bekräfta din e-postadress innan du använder Premium. Inget har ändrats.",
  },
  en: {
  ...
  es: {
    undo: "Deshacer el último deslizamiento", pending: "Comprobando acceso…", hint: "Un paso atrás · tu última elección",
    title: "Retrocede un paso con Premium", description: "Deshaz tu última elección, tanto si descartaste el nombre como si lo conservaste. La tarjeta vuelve para que puedas elegir de nuevo.",
  ...
  fr: {
    undo: "Annuler le dernier balayage", pending: "Vérification de l’accès…", hint: "Un seul retour · votre dernier choix",
