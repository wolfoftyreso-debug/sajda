...
export const accountNavigationCopy: Record<Language, { account: string; signIn: string; oneAccount: string }> = {
  ...
  es: { account: "Mi cuenta", signIn: "Iniciar sesión", oneAccount: "Una cuenta de Sajda para todos los planes. Usa la misma cuenta para buscar y acceder a Swipe y Trading; no necesitas crear otra." },
  ...
  zh: { account: "我的账户", signIn: "登录", oneAccount: "所有方案共用一个 Sajda 账户。搜索、Swipe 和 Trading 均使用同一个账户登录，无需另建账户。" },
};
