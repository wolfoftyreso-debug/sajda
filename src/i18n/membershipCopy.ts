...
const en: MembershipCopy = {
  ...
  lead: "Use one account for search, saved domains, Swipe and Trading. When your access level changes, your login stays the same.",
  ...
  assignedAccess: "Access granted by Sajda, not a paid subscription. It does not renew automatically and you will not be charged for it.",
...
const sv: MembershipCopy = {
  ...
  lead: "Använd samma konto för sökning, sparade domäner, Swipe och Trading. Inloggningen är densamma även när du byter nivå.",
  ...
  undo: "Ångra din senaste svajpning", trading: "Öppna Trading", comparePlans: "Jämför nivåer",
...
const es: MembershipCopy = {
  ...
  lead: "Usa una sola cuenta para buscar, guardar dominios y acceder a Swipe y Trading. Aunque cambie tu nivel de acceso, seguirás usando la misma cuenta.",
  currentPlan: "Nivel de acceso actual", loading: "Comprobando tu acceso…",
  unavailable: "No se pudo confirmar tu acceso", unavailableDetail: "Tu sesión sigue abierta. Inténtalo de nuevo para ver tu nivel y las funciones disponibles.",
...
const fr: MembershipCopy = {
  ...
  lead: "Utilisez un seul compte pour rechercher, enregistrer des domaines et accéder à Swipe et Trading. Vos identifiants restent les mêmes lorsque votre niveau d’accès change.",
...
const zh: MembershipCopy = {
  ...
  lead: "搜索、保存域名、Swipe 和 Trading 共用一个账户。访问级别改变后，你仍使用同一个账户登录。",
  ...
  currentFeatures: "此账户的可用功能", search: "搜索域名", swipe: "打开 Swipe", saved: "已保存的域名",
