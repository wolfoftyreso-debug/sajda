...
const sv: PricingCopy = {
  ...
  lead: "Börja gratis. Bas är tänkt för enstaka projekt och Premium för dig som bygger ofta. Trading är en separat arbetsyta för domänresearch, inte ett krav för att hitta bra namn.",
  ...
  plans: {
    free: { name: "Gratis", audience: "För att komma igång", description: "Testa en idé och förstå vad Sajda kan hjälpa dig med.", points: ["Prova domänsökningen", "Se registerstatus", "Jämför tillgängliga prisunderlag", "Spara domäner med verifierat konto"] },
...
const en: PricingCopy = {
  ...
  lead: "Start free. Basic is designed for occasional projects and Premium for people who build regularly. Trading is a separate domain research workspace, not a requirement for finding good names.",
  ...
  plans: {
    free: { name: "Free", audience: "To get started", description: "Try an idea and discover how Sajda can help.", points: ["Try domain search", "See registry status", "Compare available price evidence", "Save domains with a verified account"] },
...
const es: PricingCopy = {
  ...
  lead: "Empieza gratis. Básico está pensado para proyectos ocasionales y Premium para quienes crean proyectos con frecuencia. Trading es un espacio de investigación de dominios; no lo necesitas para encontrar buenos nombres.",
  ...
  plans: {
    free: { name: "Gratis", audience: "Para empezar", description: "Prueba una idea y descubre cómo puede ayudarte Sajda.", points: ["Probar la búsqueda de dominios", "Consultar el estado en el registro", "Comparar los datos de precios disponibles", "Guardar dominios con una cuenta verificada"] },
...
const fr: PricingCopy = {
  ...
  lead: "Commencez gratuitement. Basique est prévu pour les projets occasionnels, Premium pour ceux qui créent régulièrement. Trading est un espace de recherche sur les domaines ; il n’est pas nécessaire pour trouver de bons noms.",
  ...
  plans: {
    free: { name: "Gratuit", audience: "Pour commencer", description: "Testez une idée et découvrez comment Sajda peut vous aider.", points: ["Essayer la recherche de domaines", "Consulter le statut dans le registre", "Comparer les données de prix disponibles", "Enregistrer des domaines avec un compte vérifié"] },
...
const zh: PricingCopy = {
  back: "返回搜索", eyebrow: "一个 Sajda 账户，四种访问级别。", title: "为你的项目找到合适的名字。",
  lead: "先免费试用。基础方案面向偶尔开展项目的用户，Premium 面向经常创建项目的用户。Trading 是专门的域名研究工作区，寻找好名字不需要开通 Trading。",
  ...
  plans: {
    free: { name: "免费", audience: "适合初次尝试", description: "尝试一个创意，了解 Sajda 能为你做什么。", points: ["试用域名搜索", "查看注册状态", "比较现有价格信息", "通过已验证的账户保存域名"] },
