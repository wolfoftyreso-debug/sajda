...
const securityCopy: Record<Language, SecurityCopy> = {
  en: {
    ...
    signal: {
      ...
      title: "A useful result keeps its evidence attached.",
      ...
      rows: [
        { label: "Registry signal", body: "A route used to check a domain, with the returned status kept visible." },
    ...
    principles: {
      ...
      title: "Useful information, stated at the right strength.",
      lead: "The product is designed to keep the hand-off and the uncertainty visible—not hide them behind a polished result.",
      cards: [
        ...
        { title: "Unknown is not a claim", body: "When a route cannot confirm a status, Sajda keeps the status unknown. It does not turn an absence of evidence into an available result." },
    ...
    access: {
      eyebrow: "API access",
      title: "Built for bounded, server-side use.",
  ...
  sv: {
    ...
    signal: {
      ...
      title: "Ett användbart resultat behåller sitt underlag.",
      body: "Vi skiljer på registry-signal, prisinformation och leverantörens slutliga kassa så att du ser vad som är känt, vad som inte är det och vad som fortfarande behöver bekräftas.",
      rows: [
        { label: "Registry-signal", body: "Vägen som användes för att kontrollera en domän, med den returnerade statusen synlig." },
    ...
    principles: {
      ...
      title: "Användbar information, uttryckt med rätt säkerhet.",
      lead: "Produkten är skapad för att göra överlämningen och osäkerheten synliga—inte dölja dem bakom ett polerat resultat.",
      cards: [
        { title: "Tillgänglighet behöver bekräftas", body: "Ett registry-svar är en söksignal, inte ett löfte om att ett namn fortfarande går att köpa. Bekräfta tillgänglighet före betalning." },
        ...
        { title: "Okänt är inte ett påstående", body: "När en väg inte kan bekräfta statusen behåller Sajda statusen som okänd. Avsaknad av underlag blir inte ett ledigt resultat." },
        { title: "Registrar-lösenord hör inte hemma här", body: "Sajda frågar aldrig efter, samlar inte in och lagrar inte registrar-lösenord." },
      ],
    },
    availability: {
      eyebrow: "Underlag för tillgänglighet",
      title: "Kontrollera först. Bestäm sedan.",
      lead: "Tillgänglighet är ett levande tillstånd. Sajda visar underlagsvägen och behåller skillnaden mellan ett bekräftat svar och ett olöst svar.",
      steps: [
        { title: "Sök en domän", body: "En exakt domän eller en skapad kandidat förbereds för rätt registry-väg." },
        { title: "Läs den returnerade statusen", body: "Resultatet speglar vad den vägen kan styrka. En misslyckad eller ofullständig väg förblir synlig som olöst." },
      ...
      unknownBody: "En registry- eller leverantörsväg kan vara otillgänglig, fördröjd eller inte kunna fastställa en status. Då märker Sajda inte domänen som ledig eller upptagen på gissning.",
    },
    access: {
      eyebrow: "API-åtkomst",
      title: "Byggt för begränsad användning från serversidan.",
      lead: "Det publika API:t är medvetet begränsat och rate-limitat. Det är avsett för kontrollerade integrationer, inte obegränsad åtkomst i webbläsaren.",
      cards: [
        { title: "Publika anrop rate-limitas", body: "Publika vägar har definierade anropsgränser så att den delade tjänsten förblir förutsägbar och motståndskraftig mot missbruk." },
    ...
    marketplace: {
      ...
      title: "En annons bör börja med underlag för kontroll.",
  ...
  es: {
    ...
    signal: {
      ...
      title: "Un resultado útil conserva su evidencia.",
    ...
    principles: {
      ...
      title: "Información útil, expresada con la fuerza adecuada.",
      lead: "El producto está diseñado para mantener visible la transferencia y la incertidumbre, no para ocultarlas detrás de un resultado pulido.",
      cards: [
        ...
        { title: "Desconocido no es una afirmación", body: "Cuando una ruta no puede confirmar un estado, Sajda lo mantiene como desconocido. La falta de evidencia no se convierte en un resultado disponible." },
    ...
    availability: {
      ...
      lead: "La disponibilidad es una condición en vivo. Sajda muestra la ruta de evidencia y mantiene la diferencia entre una respuesta confirmada y una sin resolver.",
      steps: [
      ...
      unknownBody: "Una ruta de registro o proveedor puede no estar disponible, demorarse o no poder establecer un estado. En ese caso, Sajda no etiqueta el dominio como disponible o tomado por conjetura.",
    },
    access: {
      eyebrow: "Acceso API",
  ...
  fr: {
    ...
    signal: {
      ...
      title: "Un résultat utile conserve ses éléments de preuve.",
    ...
    principles: {
      ...
      lead: "Le produit est conçu pour rendre le transfert et l’incertitude visibles, et non pour les masquer derrière un résultat soigné.",
      cards: [
        ...
        { title: "Inconnu n’est pas une affirmation", body: "Lorsqu’un chemin ne peut confirmer un état, Sajda le conserve comme inconnu. L’absence de preuve ne devient pas un résultat disponible." },
        { title: "Les mots de passe registrar n’ont pas leur place ici", body: "Sajda ne demande, ne collecte et ne stocke jamais les mots de passe de registrar." },
      ],
    },
    availability: {
      eyebrow: "Preuve de disponibilité",
      title: "Vérifiez d’abord. Décidez ensuite.",
      lead: "La disponibilité est une condition active. Sajda montre le chemin de preuve et préserve la différence entre une réponse confirmée et une réponse non résolue.",
      steps: [
      ...
      unknownBody: "Un chemin de registre ou de fournisseur peut être indisponible, retardé ou incapable d’établir un état. Dans ce cas, Sajda ne qualifie pas le domaine de disponible ou pris par conjecture.",
    },
    access: {
      eyebrow: "Accès API",
  ...
  zh: {
    ...
    signal: {
      ...
      rows: [
        { label: "注册局信号", body: "用于核验域名的路径，以及保持可见的返回状态。" },
    ...
    principles: {
      eyebrow: "运行原则",
      title: "有用的信息，以恰当的确定性表达。",
      lead: "产品设计的目标是让交接与不确定性可见，而不是用精美结果把它们藏起来。",
      cards: [
        { title: "可用性需要确认", body: "注册局响应是搜索信号，不是名称仍然可购买的承诺。请在付款前确认可用性。" },
        { title: "服务商结账保持外部进行", body: "Sajda 会将你带到所选服务商完成订单。其结账页决定最终价格、条款与可用性。" },
        { title: "未知不是一种声明", body: "当路径无法确认状态时，Sajda 会保留未知状态。没有依据不会变成可注册结果。" },
    ...
    availability: {
      eyebrow: "可用性依据",
      title: "先核验。再决定。",
      lead: "可用性是实时条件。Sajda 显示证据路径，并保留已确认响应与未解决响应之间的区别。",
      steps: [
        { title: "搜索域名", body: "精确域名或生成的候选名称会被准备到相应的注册局路径。" },
        { title: "阅读返回状态", body: "结果反映该路径能够支持的内容。失败或不完整的路径会保持为未解决状态。" },
        { title: "向服务商确认", body: "打开服务商查看当前购买条件，并让其结账页确认最终交易。" },
      ],
      unknownTitle: "未核验是诚实的答案。",
      unknownBody: "注册局或服务商路径可能不可用、延迟，或无法确定状态。此时，Sajda 不会通过猜测把域名标记为可注册或已注册。",
    },
    access: {
      eyebrow: "API 访问",
      title: "为受限的服务端使用而构建。",
      ...
      cards: [
        ...
        { title: "使用已记录的路径", body: "开发者区域显示支持的域名搜索路径和它们接受的请求格式。" },
      ],
    },
    marketplace: {
      eyebrow: "交易市场发布",
