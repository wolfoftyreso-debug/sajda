...
const installMessages = {
  ...
  es: {
    ...
    offlineDescription: "Las búsquedas, comprobaciones en vivo, precios y actualizaciones de cuenta requieren conexión a internet.",
  ...
  fr: {
    ...
    offlineDescription: "Les recherches, vérifications en direct, prix et mises à jour du compte nécessitent internet.",
