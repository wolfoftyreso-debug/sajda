...
const authMessages = {
  en: {
    ...
    emailUnavailable: "Account email is not enabled yet. You can still search for domains without an account.",
    ...
    startWatching: "Start tracking valuable domains",
    email: "Email",
  ...
  sv: {
    ...
    emailUnavailable: "Kontomejl är inte aktiverade ännu. Du kan fortfarande söka domäner utan konto.",
    ...
    tagline: "Domänupptäckt",
    welcomeBackHeading: "Välkommen tillbaka",
    createAccount: "Skapa konto",
    accountAccess: "Logga in till ditt Sajda-konto",
    startWatching: "Börja bevaka värdefulla domäner",
    email: "E-post",
  ...
  es: {
    ...
    emailUnavailable: "El correo de cuentas aún no está activado. Puedes seguir buscando dominios sin una cuenta.",
    ...
    unavailableTitle: "Las cuentas no están conectadas en esta vista previa.",
  ...
  fr: {
    ...
    emailUnavailable: "Les e-mails de compte ne sont pas encore activés. Vous pouvez toujours rechercher des domaines sans compte.",
    ...
    startWatching: "Commencez à suivre des domaines de valeur",
    email: "E-mail",
    ...
    unavailableTitle: "Les comptes ne sont pas connectés dans cet aperçu.",
...
const passwordRecoveryMessages = {
  en: {
    ...
    passwordUpdated: "Your password has been changed. You can continue securely.",
  ...
  sv: {
    ...
    passwordUpdated: "Ditt lösenord har ändrats. Du kan fortsätta säkert.",
  ...
  es: {
    ...
    passwordUpdated: "Tu contraseña ha cambiado. Puedes continuar de forma segura.",
  ...
  fr: {
    ...
    passwordUpdated: "Votre mot de passe a été modifié. Vous pouvez continuer en toute sécurité.",
  ...
  zh: {
    ...
    passwordUpdated: "你的密码已更改，可以安全继续。",
...
const Auth = () => {
  ...
  const verifyCopy = language === "sv" ? {
    required: "Bekräfta din e-postadress via länken i inkorgen innan du loggar in.",
    resend: "Skicka en ny bekräftelselänk",
    sent: "Om kontot behöver bekräftas har en ny länk skickats till din e-post.",
    failed: "Det gick inte att skicka länken. Vänta en stund och försök igen.",
    wait: "För många försök. Vänta några minuter och försök igen.",
  } : {
    required: "Confirm your email using the link in your inbox before signing in.",
    resend: "Send a new confirmation link",
    sent: "If the account needs confirmation, a new link has been sent to your email.",
    failed: "The link could not be sent. Wait a moment and try again.",
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <section className="w-full max-w-md rounded-2xl border border-border bg-card p-7 shadow-[0_18px_52px_hsl(219_44%_12%/0.08)] sm:p-8">
          ...
          <p className="mt-5 text-[11px] font-semibold uppercase tracking-[0.14em] text-primary">Sajda account</p>
