...
const howItWorksCopy: Record<Language, HowItWorksCopy> = {
  en: {
    ...
    context: {
      ...
      reviewTitle: "See why names make the Top 10",
      reviewBody: "Deep review ranks only names confirmed available by an authoritative check. It shows how each score is calculated, not a financial valuation.",
      reviewPoints: [
      ...
      developerAction: "Read the API and MCP documentation",
    },
    finish: {
  ...
  sv: {
    ...
    context: {
      ...
      reviewTitle: "Se varför namnen hamnar i topp 10",
      reviewBody: "Djupgranskningen rangordnar bara namn som bekräftats lediga vid en tillförlitlig registerkontroll. Den visar hur poängen beräknas, inte en ekonomisk värdering.",
      reviewPoints: [
      ...
      developerAction: "Läs dokumentationen för API och MCP",
    },
    finish: {
  ...
  es: {
    ...
    resultRows: [
      ...
      { label: "Puntuación del nombre", body: "Una puntuación con criterios claros para comparar, no una valoración económica." },
    ],
    direction: {
    ...
    evidence: {
      ...
      flow: [
        ...
        { title: "Mostrar el resultado", body: "Un dominio solo figura como disponible tras la confirmación del registro; las comprobaciones fallidas o no concluyentes quedan como desconocidas." },
    ...
    context: {
      ...
      reviewTitle: "Descubre por qué estos nombres están en el Top 10",
      reviewBody: "El análisis detallado solo ordena nombres cuya disponibilidad ha confirmado el registro. Muestra cómo se calcula cada puntuación, no una valoración económica.",
      ...
      developerAction: "Leer la documentación de API y MCP",
    },
    finish: {
  ...
  fr: {
    ...
    status: "Sajda vous aide à comparer ; le fournisseur confirme la disponibilité et le prix final avant l’achat.",
    ...
    resultRows: [
      ...
      { label: "Prix", body: "Un prix actuel sourcé, s’il existe, ou un lien pour consulter le fournisseur." },
    ...
    evidence: {
      ...
      lead: "Découvrez si le nom est disponible et combien facture un fournisseur, avec les informations inconnues clairement indiquées.",
      ...
      flow: [
        ...
        { title: "Confirmer avant l’achat", body: "La disponibilité peut changer ; le fournisseur la confirme donc à nouveau avant le paiement." },
      ],
      priceTitle: "Comprendre le prix",
      priceLead: "Comparez les prix sourcés de fournisseurs sélectionnés ; un score ou une estimation n’est pas un prix d’enregistrement.",
      prices: [
        ...
        { label: "Prix inconnu", title: "Consulter le fournisseur", body: "Sans source de prix actuelle, Sajda renvoie vers la recherche du fournisseur au lieu de deviner un montant." },
        { label: "Avant de payer", title: "Confirmer le coût total", body: "Confirmez promotions, taxes, prix premium, conditions de renouvellement et disponibilité auprès du fournisseur avant le paiement." },
      ],
    ...
    context: {
      ...
      reviewTitle: "Comprendre le classement du Top 10",
      ...
      reviewPoints: ["Lisibilité et longueur pratique", "Adéquation avec votre thème et extension choisie", "Confirmation du registre et clarté du prix", "Un signal de recherche visible, pas une conclusion juridique ou de marque"],
      ...
      limits: ["Sajda ne valide pas les droits de marque, ne donne pas de conseil juridique et ne transfère pas la propriété des domaines.", "Les comparaisons ne couvrent pas tous les fournisseurs, marchés de revente ou ventes privées.", "Les prix et les achats ne sont pas garantis avant confirmation par le fournisseur au paiement.", "La disponibilité reste inconnue si le contrôle du registre ne peut pas la confirmer."],
      developerAction: "Lire la documentation API et MCP",
    },
    finish: {
      title: "Prêt à trouver votre domaine ?",
      body: "Commencez par un nom ou une idée et comparez les options avant d’acheter auprès d’un fournisseur.",
  ...
  zh: {
    ...
    evidence: {
      ...
      priceTitle: "看懂价格",
      priceLead: "比较所选服务商有明确来源的价格；名称评分或估算并不是注册价格。",
      prices: [
        { label: "有价格信息", title: "查看来源与日期", body: "价格来源保持最新；如果币种和含税情况已知，也会一并显示。" },
    ...
    context: {
      eyebrow: "第 3 步 · 比较",
      title: "比较最佳候选",
      lead: "从已确认可注册的域名中选出 前 10 名，并了解每个名称的排名理由。",
      reviewTitle: "了解前 10 名的入选理由",
      reviewBody: "深度分析只对经过权威检查确认可注册的名称排序，并展示评分明细，而不是财务估值。",
      ...
      developerAction: "阅读 API 和 MCP 文档",
    },
    finish: {
      title: "准备好寻找你的域名了吗？",
