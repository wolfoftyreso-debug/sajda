...
const storyCopy: Record<Language, StoryCopy> = {
  en: {
    ...
    title: "Every valuable name begins as a signal.",
    lead: "Sajda is a search studio named in tribute to Saida Andersson. Our editorial story turns the old instinct to seek what is missing into a modern route to the domain name worth keeping.",
    ...
    portraitFallback: "Sajda story portrait placeholder",
    ...
    methodLabel: "The practice beneath the story",
    methodTitle: "A ritual, translated into evidence.",
    methodLinkLabel: "Explore how it works",
    methodLinkAria: "Read how this part of Sajda works",
    methodItems: [
      { title: "Find a direction", body: "Turn an idea, reference word, or detailed brief into naming paths you can actually use." },
      { title: "Check the evidence", body: "Verify domain availability through registry sources and keep price information visibly sourced." },
      { title: "Choose with context", body: "Compare providers, shortlist the strongest options, and make the final decision yourself." },
    ],
    distinctionLabel: "Story and record",
    ...
    fictionTitle: "The editorial layer",
  ...
  sv: {
    ...
    title: "Varje värdefullt namn börjar som en signal.",
    lead: "Sajda är en sökstudio, döpt som en hyllning till Saida Andersson. Vår redaktionella berättelse gör den gamla instinkten att söka efter det som saknas till en modern väg mot domännamnet värt att behålla.",
    ...
    portraitFallback: "Platshållare för Sajdas berättelseporträtt",
    portraitCaption: "Portrait of Saida Andersson, Landvex",
    prologueLabel: "Sajda-memorandumet",
    prologueTitle: "En rad för den sökbara världen",
    ...
    methodLabel: "Praktiken under berättelsen",
    methodTitle: "En ritual, översatt till underlag.",
    methodLinkLabel: "Se hur det fungerar",
    methodLinkAria: "Läs hur den här delen av Sajda fungerar",
    methodItems: [
      { title: "Hitta en riktning", body: "Förvandla en idé, ett referensord eller en detaljerad beskrivning till namnspår du faktiskt kan använda." },
      { title: "Kontrollera underlaget", body: "Verifiera domäntillgänglighet mot registry-källor och visa var prisinformationen kommer ifrån." },
      { title: "Välj med sammanhang", body: "Jämför leverantörer, gör en kortlista över de starkaste alternativen och fatta själv det slutliga beslutet." },
    ],
    ...
    fictionTitle: "Det redaktionella lagret",
    ...
    ctaBody: "Kom med ett ord, en magkänsla eller en exakt domän. Sajda gör det till ett tydligt nästa steg—och visar underlaget.",
  ...
  es: {
    ...
    title: "Todo nombre valioso comienza como una señal.",
    lead: "Sajda es un estudio de búsqueda llamado así en homenaje a Saida Andersson. Nuestra historia editorial convierte el antiguo impulso de buscar lo que falta en una ruta moderna hacia el nombre de dominio que merece conservarse.",
    ...
    portraitFallback: "Marcador de posición para el retrato de la historia de Sajda",
    portraitCaption: "Portrait of Saida Andersson, Landvex",
    prologueLabel: "El memorando de Sajda",
    prologueTitle: "Una nota para el mundo buscable",
    ...
    principleByline: "— de la editorial contemporánea de Sajda",
    methodLabel: "La práctica bajo la historia",
    methodTitle: "Un ritual traducido en evidencia.",
    methodLinkLabel: "Ver cómo funciona",
    methodLinkAria: "Lee cómo funciona esta parte de Sajda",
    methodItems: [
      { title: "Encontrar una dirección", body: "Convierte una idea, una palabra de referencia o un briefing detallado en rutas de nombre que realmente puedes usar." },
      ...
      { title: "Elegir con contexto", body: "Compara proveedores, crea una lista corta de las mejores opciones y toma tú la decisión final." },
    ],
    distinctionLabel: "Historia y registro",
    ...
    fictionTitle: "La capa editorial",
    ...
    ctaBody: "Trae una palabra, una intuición o un dominio exacto. Sajda lo convierte en un siguiente paso claro y muestra la evidencia.",
  ...
  fr: {
    ...
    title: "Tout nom précieux commence comme un signal.",
    lead: "Sajda est un studio de recherche nommé en hommage à Saida Andersson. Notre récit éditorial transforme l’ancien instinct de chercher ce qui manque en une voie moderne vers le nom de domaine à garder.",
    ...
    portraitFallback: "Emplacement pour le portrait de l’histoire Sajda",
    portraitCaption: "Portrait of Saida Andersson, Landvex",
    prologueLabel: "Le mémorandum Sajda",
    prologueTitle: "Une note pour le monde recherchable",
    ...
    principleByline: "— de l’éditorial Sajda contemporain",
    methodLabel: "La pratique sous le récit",
    methodTitle: "Un rituel traduit en preuves.",
    methodLinkLabel: "Voir comment cela fonctionne",
    methodLinkAria: "Découvrir le fonctionnement de cette partie de Sajda",
    methodItems: [
      { title: "Trouver une direction", body: "Transformez une idée, un mot de référence ou un brief détaillé en pistes de nom vraiment utilisables." },
      ...
      { title: "Choisir avec contexte", body: "Comparez les prestataires, établissez une sélection des meilleures options et prenez vous-même la décision finale." },
    ],
    distinctionLabel: "Récit et dossier",
    ...
    fictionTitle: "La couche éditoriale",
    ...
    ctaBody: "Apportez un mot, une intuition ou un domaine exact. Sajda en fait une prochaine étape claire et montre les preuves.",
  ...
  zh: {
    ...
    backToSearch: "返回搜索",
    storyLabel: "一篇编辑序章",
    title: "每一个有价值的名字都始于一个信号。",
    lead: "Sajda 是一家搜索工作室，名称旨在致敬 Saida Andersson。我们的编辑故事将寻找失物的古老直觉，转化为通往值得保留的域名的现代路径。",
    disclosure: "这是 Sajda 的当代诠释：回忆录、笔记与面向未来的语言描述的是我们的工作方法，而非历史文献或承诺。",
    searchAction: "开始搜索",
    portraitAlt: "为 Sajda 故事创作的黑白编辑肖像插画",
    portraitFallback: "Sajda 故事肖像占位图",
    portraitCaption: "Portrait of Saida Andersson, Landvex",
    prologueLabel: "Sajda 备忘录",
    prologueTitle: "写给可搜索世界的一则笔记",
    prologue: "在 Sajda 的编辑叙述中，回忆录里的一则笔记想象了一个名字密布的世界，并问：哪些名字会最先被找到？答案并非魔法：让信号令人记住，检验证据，并在路径仍然开放时行动。",
    principle: "“稀有的不是名字，而是在别人之前理解它为何重要。”",
    principleByline: "——摘自 Sajda 当代编辑叙述",
    methodLabel: "故事之下的实践",
    methodTitle: "将仪式转化为证据。",
    ...
    methodItems: [
      ...
      { title: "带着上下文做选择", body: "比较供应商，整理最有力的选项，最终由你自己作出决定。" },
    ],
    distinctionLabel: "故事与档案",
    factTitle: "历史参考",
    ...
    radioSource: "Sveriges Radio：Saida Andersson",
    ctaTitle: "找到值得保留的那个。",
    ctaBody: "带来一个词、一个直觉或一个确切域名。Sajda 会将它转化为清晰的下一步，并展示背后的证据。",
    ctaAction: "寻找你的下一个名称",
  },
};
