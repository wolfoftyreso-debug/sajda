...
const developerKeyCopy: Record<Language, DeveloperKeyCopy> = {
  en: {
    ...
    createLead: "Give this key a clear name so you can recognize the server that uses it.",
    nameLabel: "Key name",
    ...
    listLead: "The full key is not saved to browser storage.",
    refresh: "Refresh",
  ...
  sv: {
    ...
    listLead: "Den fullständiga nyckeln sparas inte i webbläsarens lagring.",
    refresh: "Uppdatera",
  ...
  es: {
    ...
    listLead: "La clave completa no se guarda en el almacenamiento del navegador.",
    refresh: "Actualizar",
  ...
  fr: {
    ...
    listLead: "La clé complète n’est pas conservée dans le stockage du navigateur.",
    refresh: "Actualiser",
...
const developerCopy: Record<Language, DeveloperCopy> = {
  en: {
    ...
    title: "Build domain search with evidence behind every result.",
    ...
    publicTitle: "Explore the public API.",
    ...
    publicFacts: "Domain market facts with sources",
    ...
    boundariesTitle: "Understand what the results can tell you.",
    boundaries: [
      { title: "Availability is evidence-led", body: "A result can be available, taken or unknown. Unknown never means available to register." },
  ...
  sv: {
    ...
    title: "Bygg domänsökning med underlag för varje resultat.",
    ...
    liveLabel: "Tillgängliga ändpunkter",
    ...
    publicTitle: "Utforska det publika API:t.",
    ...
    publicDomains: "Avgränsad domänsökning med registerunderlag",
    protectedDomains: "Nyckelskyddad domänsökning för serverintegrationer",
    publicFacts: "Domänmarknadsdata med källor",
    publicRateLimit: "Delad gräns utan kapacitetsgaranti: 6 anrop per IP och minut. Svaren innehåller anrops-id och HTTP-headers för anropsgränsen. Detta är inte en betald kvot eller ett servicenivåavtal.",
    ...
    endpointLabel: "Exempelanrop",
    contractLabel: "Maskinläsbar API-specifikation",
    copy: "Kopiera",
    copied: "Kopierat",
    boundariesLabel: "Driftsgränser",
    boundariesTitle: "Förstå vad resultaten faktiskt visar.",
    boundaries: [
      { title: "Tillgänglighet bygger på underlag", body: "Ett resultat kan vara ledigt, upptaget eller okänt. Okänt betyder aldrig att domänen går att registrera." },
      { title: "Priserna är inte slutliga köpbesked", body: "Leverantörssignaler hålls skilda från tillgänglighet och måste bekräftas hos leverantören." },
      { title: "Nyckeln hålls borta från klienten", body: "Använd din nyckel endast från en betrodd server. Bädda aldrig in den i klientkoden för en webbplats, ett webbläsartillägg eller en mobilapp." },
    ],
  },
  es: {
    ...
    title: "Crea una búsqueda de dominios con datos que respalden cada resultado.",
    ...
    liveLabel: "Endpoints disponibles",
    ...
    publicTitle: "Explora la API pública.",
    ...
    publicFacts: "Datos del mercado de dominios con fuentes",
    publicRateLimit: "Límite compartido sin garantía de capacidad: 6 solicitudes por IP y minuto. Las respuestas incluyen un ID de solicitud y cabeceras de límite. No es una cuota de pago ni un acuerdo de nivel de servicio.",
    ...
    boundariesTitle: "Entiende qué te dicen los resultados.",
    boundaries: [
      { title: "La disponibilidad se basa en evidencia", body: "Un resultado puede ser disponible, ocupado o desconocido. Desconocido nunca significa que se pueda registrar." },
      { title: "Los precios no son importes finales de compra", body: "Las señales del proveedor permanecen separadas de la disponibilidad y requieren confirmación final del proveedor." },
  ...
  fr: {
    ...
    title: "Créez une recherche de domaines avec des preuves pour chaque résultat.",
    ...
    liveLabel: "Points d’accès disponibles",
    ...
    publicTitle: "Explorez l’API publique.",
    ...
    publicFacts: "Données du marché des domaines avec sources",
    publicRateLimit: "Limite partagée sans garantie de capacité : 6 requêtes par IP et par minute. Les réponses incluent un identifiant de requête et des en-têtes de limitation. Ce n’est ni un quota payant ni un accord de niveau de service.",
    ...
    boundariesTitle: "Comprenez ce que les résultats vous indiquent.",
    boundaries: [
      { title: "La disponibilité repose sur des preuves", body: "Un résultat peut être disponible, déjà enregistré ou inconnu. Inconnu ne signifie jamais disponible à l’enregistrement." },
  ...
  zh: {
    ...
    publicFacts: "有来源的域名市场数据",
    publicRateLimit: "共享请求上限：每个 IP 每分钟 6 次，不保证处理容量。响应包含请求 ID 和限流标头。这不是付费配额，也不构成服务级别协议。",
    runExample: "运行实时示例",
    running: "请求中…",
    ...
    serverOnly: "仅限服务器",
    endpointLabel: "示例请求",
    contractLabel: "机器可读的 API 规范",
    copy: "复制",
    copied: "已复制",
    boundariesLabel: "运行边界",
    boundariesTitle: "了解结果能说明什么。",
    boundaries: [
