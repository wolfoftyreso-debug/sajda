...
const copy = {
  en: {
    ...
    trending: {
      ...
      headerNote: "Up to 50 suggestions",
    ...
    brief: {
      ...
      description: "Add your audience, preferred style and words to include or avoid.",
      detail: "Set the extensions and criteria that matter to you.",
      action: "Open advanced search",
    },
  },
  sv: {
    label: "Välj en sökväg",
    ...
    swipe: {
      ...
      description: "Se en kort domän i taget. Spara dem du gillar och hoppa över resten.",
      detail: "Varje kort visar domänens aktuella status.",
      action: "Bläddra bland domäner",
    },
    trending: {
      eyebrow: "Domänförslag",
      headerNote: "Upp till 50 förslag",
    ...
    brief: {
      ...
      description: "Lägg till målgrupp, önskad stil och ord du vill ha med eller undvika.",
      detail: "Välj de ändelser och kriterier som är viktiga för dig.",
      action: "Öppna avancerad sökning",
    },
  },
  es: {
    label: "Elige una ruta de búsqueda",
    helper: "Tres caminos. Un sistema de búsqueda claro.",
    swipe: {
      eyebrow: "Dominios cortos",
      headerNote: "100 nombres por baraja",
      title: "Explora nombres cortos",
      description: "Revisa un dominio corto verificado en el registro cada vez.",
      detail: "Un nombre cada vez · 100 por selección",
      action: "Abrir Swipe",
    },
    trending: {
      eyebrow: "Ideas de nombres",
      headerNote: "Hasta 50 propuestas",
      title: "Explora más opciones",
      description: "Genera direcciones de marca más amplias para las extensiones elegidas.",
      detail: "Más familias de palabras y combinaciones útiles",
      action: "Explorar nombres",
    },
    brief: {
      eyebrow: "Busca con tu brief",
      headerNote: "Tú defines los criterios",
      title: "Convierte contexto en nombres",
      description: "Usa el contexto, palabras de referencia y límites para enfocar resultados.",
      detail: "Útil cuando el nombre debe encajar con un producto concreto",
      action: "Abrir búsqueda avanzada",
    },
  },
  fr: {
    label: "Choisissez un parcours de recherche",
    helper: "Trois entrées. Un système de recherche clair.",
    swipe: {
      eyebrow: "Domaines courts",
      headerNote: "100 noms par série",
      title: "Parcourir des noms courts",
      description: "Examinez un domaine court vérifié auprès du registre à la fois.",
      detail: "Un nom à la fois · 100 par sélection",
      action: "Ouvrir Swipe",
    },
    trending: {
      eyebrow: "Idées de noms",
      headerNote: "Jusqu’à 50 propositions",
      title: "Explorer plus largement",
      description: "Générez des pistes de marque plus larges pour les extensions choisies.",
      detail: "Davantage de familles de mots et de combinaisons utiles",
      action: "Explorer les noms",
    },
    brief: {
      eyebrow: "Cherchez avec votre brief",
      headerNote: "Vous fixez les critères",
      title: "Transformer le contexte en noms",
      description: "Utilisez le brief, des mots repères et des contraintes pour cibler les résultats.",
      detail: "Utile lorsque le nom doit convenir à un produit précis",
      action: "Ouvrir la recherche avancée",
    },
  },
  zh: {
    label: "选择搜索方式",
    helper: "三种入口，一个清晰的搜索系统。",
    swipe: {
      eyebrow: "短域名",
      headerNote: "每组 100 个名称",
      title: "浏览简短名称",
      description: "逐一查看已通过注册局核验的简短域名。",
      detail: "一次查看一个名称 · 每组 100 个",
      action: "打开 Swipe",
    },
    trending: {
      eyebrow: "名称灵感",
      headerNote: "最多 50 个建议",
      title: "探索更多方向",
      description: "围绕已选后缀生成更广泛、更适合品牌的命名方向。",
      detail: "更多词组方向与实用组合",
      action: "探索名称",
    },
    brief: {
      ...
      headerNote: "由你设定条件",
      title: "把语境转化为名称",
      description: "使用说明、参考词和限制条件，让结果更聚焦。",
      detail: "适合名称必须贴合具体产品时使用",
      action: "打开高级搜索",
    },
  },
} as const;
