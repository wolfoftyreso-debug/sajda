...
const copy = {
  ...
  es: {
    ...
    brief: {
      ...
      description: "Añade tu público, el estilo que prefieres y las palabras que quieras incluir o evitar.",
  ...
  fr: {
    ...
    brief: {
      ...
      description: "Précisez votre public, le style souhaité et les mots à inclure ou à éviter.",
  ...
  zh: {
    ...
    brief: {
      ...
      headerNote: "由你设定条件",
      title: "描述你的需求",
      description: "补充目标受众、偏好风格，以及希望包含或排除的词语。",
