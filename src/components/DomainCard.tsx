...
const providerComparisonCopy = {
  en: {
    ...
    allSelectedProvidersDescription: "Every selected seller is shown below. A number appears only when a current, verified price source returned one.",
    ...
    noPublishedPrice: "No published price connected",
    ...
    credentialsPending: "Credentials set — adapter pending",
    credentialsPendingDescription: "An official API is configured, but a reviewed price adapter is not active yet.",
    ...
    sellerLinksDescription: "These providers remain selected, but are purchase links until a live-price source is connected.",
    ...
    noLivePricesDescription: "The selected providers below are purchase links, not scraped quotes.",
    standardPriceDescription: "Published first-year price for this extension — not an exact-domain quote. Check checkout for promotions, tax and renewal.",
  ...
  sv: {
    ...
    allSelectedProvidersDescription: "Alla valda säljare visas nedan. Belopp visas bara när en aktuell, verifierad priskälla har returnerat ett.",
    ...
    notComparableDescription: "Namnsignalen är inte ett marknadsvärde, därför delas den inte med ett publicerat TLD-pris.",
    liveDomainOffer: "Live-domänerbjudande",
    ...
    noPublishedPrice: "Inget publicerat pris är anslutet",
    sourceChecked: "Källa kontrollerad",
    sourceCheckedNoQuote: "Källan har kontrollerats, men returnerade inget verifierat pris.",
    ...
    credentialsPending: "Inloggningsuppgifter satta — adapter väntar",
    credentialsPendingDescription: "Ett officiellt API är konfigurerat, men en granskad prisadapter är ännu inte aktiv.",
    ...
    sellerLinksDescription: "Dessa leverantörer är fortfarande valda, men är köplänkar tills en live-priskälla är ansluten.",
    ...
    noLivePricesDescription: "Leverantörerna nedan är köplänkar, inte skrapade priser.",
    standardPriceDescription: "Publicerat förstaårspris för denna ändelse — inte en offert för den exakta domänen. Kontrollera kampanj, skatt och förnyelse i kassan.",
    firstYear: "Första året",
    renewal: "Förnyelse",
    icannFee: "ICANN-avgift",
    taxesFeesMayApply: "Skatt och avgifter kan tillkomma.",
    tldesPriceFeed: "TLD-ES prisflöde",
    hourlyFeedUpdated: "Timvis prisflöde uppdaterat {time}",
    openProvider: "Öppna leverantören",
  ...
  es: {
    ...
    allSelectedProvidersDescription: "Cada vendedor seleccionado aparece abajo. Solo se muestra una cifra cuando una fuente de precio actual y verificada la devuelve.",
    ...
    notComparableDescription: "Una señal de evaluación no es una valoración de mercado, por lo que Sajda no la divide por un precio publicado de TLD.",
    liveDomainOffer: "Oferta de dominio en vivo",
    ...
    noPublishedPrice: "No hay un precio publicado conectado",
    ...
    credentialsPending: "Credenciales listas — adaptador pendiente",
    credentialsPendingDescription: "Una API oficial está configurada, pero el adaptador de precios revisado aún no está activo.",
    ...
    sellerLinksDescription: "Estos proveedores siguen seleccionados, pero son enlaces de compra hasta que se conecte una fuente de precios en vivo.",
    ...
    noLivePricesDescription: "Los proveedores seleccionados son enlaces de compra, no precios extraídos.",
    ...
    hourlyFeedUpdated: "Fuente horaria actualizada a las {time}",
  ...
  fr: {
    ...
    priceCoverage: "Couverture des prix",
    priceCoverageSummary: "{published} publiés · {checked} vérifiés · {links} liens de paiement",
    allSelectedProviders: "Tous les fournisseurs sélectionnés",
    allSelectedProvidersDescription: "Chaque vendeur sélectionné apparaît ci-dessous. Un montant n’est affiché que lorsqu’une source de prix actuelle et vérifiée le renvoie.",
    ...
    notComparableDescription: "Un signal de filtrage n’est pas une évaluation de marché ; Sajda ne le divise donc pas par un prix de TLD publié.",
    liveDomainOffer: "Offre de domaine en direct",
    ...
    noPublishedPrice: "Aucun prix publié connecté",
    ...
    credentialsPending: "Identifiants prêts — adaptateur en attente",
    credentialsPendingDescription: "Une API officielle est configurée, mais l’adaptateur de prix validé n’est pas encore actif.",
    ...
    sellerLinksDescription: "Ces fournisseurs restent sélectionnés, mais sont des liens d’achat tant qu’une source de prix en direct n’est pas connectée.",
    ...
    noLivePricesDescription: "Les fournisseurs sélectionnés sont des liens d’achat, pas des prix récupérés.",
    standardPriceDescription: "Prix de première année publié pour cette extension ; il ne s’agit pas d’une offre pour le domaine exact. Vérifiez promotions, taxes et renouvellement au paiement.",
    ...
    hourlyFeedUpdated: "Flux horaire mis à jour à {time}",
  ...
  zh: {
    ...
    noPublishedPrice: "未接入已发布价格",
    sourceChecked: "已检查来源",
    sourceCheckedNoQuote: "已检查该来源，但没有返回已核验价格。",
    directPurchaseLink: "直接购买链接",
    directLinkDescription: "这只是服务商链接。Sajda 尚未从该卖家获取价格。",
    credentialsPending: "凭据已设置 — 适配器待启用",
    credentialsPendingDescription: "官方 API 已配置，但经过审核的价格适配器尚未启用。",
    ...
    showSellerLinks: "显示 {count} 个直接卖家链接",
    hideSellerLinks: "隐藏直接卖家链接",
    noLivePrices: "此比较中没有已核验的服务商价格。",
    noLivePricesDescription: "所选服务商仅提供购买链接，并非已抓取的报价。",
    standardPriceDescription: "此后缀的公开首年标准价，并非该精确域名的报价。请在结账时确认促销、税费和续费价格。",
    firstYear: "首年",
    renewal: "续费",
    icannFee: "ICANN 费用",
    taxesFeesMayApply: "可能另有税费。",
    tldesPriceFeed: "TLD-ES 价格源",
    hourlyFeedUpdated: "每小时价格源更新于 {time}",
    openProvider: "打开服务商",
