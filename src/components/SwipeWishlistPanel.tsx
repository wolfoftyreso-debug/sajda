...
const wishlistMessages = {
  en: {
    ...
    description: "Separate from Saved domains in your account. Choose which names to save to your account; local tags and categories stay on this device.",
  ...
  sv: {
    ...
    description: "Separat från Sparade domäner på ditt konto. Välj vilka namn du vill spara på kontot; lokala taggar och kategorier stannar på enheten.",
    ...
    add: "Lägg till",
    categoryShortlist: "Favoriter",
    categoryBrand: "Varumärkesidé",
    categoryWatch: "Kontrollera senare",
  ...
  es: {
    ...
    description: "Esta lista es independiente de Dominios guardados en tu cuenta. Elige qué nombres guardar en la cuenta; las etiquetas y categorías locales se quedan en este dispositivo.",
    ...
    categoryBrand: "Idea de marca",
    categoryWatch: "Comprobar después",
  ...
  fr: {
    ...
    description: "Cette liste est distincte de Domaines enregistrés dans votre compte. Choisissez les noms à y enregistrer ; les étiquettes et catégories locales restent sur cet appareil.",
    ...
    categoryBrand: "Idée de marque",
    categoryWatch: "À revérifier",
    categoryLater: "Plus tard",
    available: "Disponible lors de la dernière vérification",
    taken: "Déjà enregistré lors de la dernière vérification",
  ...
  zh: {
    ...
    title: "此设备上的名称",
    description: "此列表与账户中的“已保存的域名”分开。请选择要存入账户的名称；本地标签和分类仍留在此设备上。",
    storedHere: "保存在此设备上",
    search: "筛选名称或标签",
    category: "分类",
    allCategories: "全部分类",
