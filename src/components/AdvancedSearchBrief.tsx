  ...
  const copy = presentationLanguage === "sv"
    ...
    : presentationLanguage === "es"
      ? {
          ...
          description: "Pega una descripción más extensa y la búsqueda extraerá temas, palabras y direcciones creativas para nombres.",
      ...
      : presentationLanguage === "fr"
        ? {
            ...
            description: "Collez une description plus longue et la recherche en extrait des thèmes, des mots et des pistes créatives de noms.",
        ...
        : presentationLanguage === "zh"
          ? {
              ...
              open: "打开高级搜索",
              close: "关闭高级搜索",
              description: "粘贴更长的说明，搜索会提取主题、关键词和有创意的命名方向。",
              label: "你的说明",
