...
const workspaceCopy: Record<Language, WorkspaceCopy> = {
  en: {
    ...
    signInBody: "Browse active listings without an account. Sign in to create and manage your own domains.",
    ...
    sellerLead: "Start with a clear price and a short buyer-facing description. You can request domain control immediately after creating it.",
    ...
    proofLead: "Add the exact TXT record below, then ask Sajda to check it. DNS can take a moment to propagate.",
    ...
    bulkErrors: "Fix {count} row issue(s) before importing.",
    lineLabel: "Line",
    bulkReady: "{count} listing(s) ready to create.",
  ...
  sv: {
    eyebrow: "Säljararbetsyta",
    title: "Lägg ut domäner du redan äger.",
    lead: "Skapa en annons, bevisa kontroll med en DNS TXT-post och ge sedan varje aktiv annons en direkt Sajda-sida och en nedladdningsbar säljsida.",
    signInTitle: "Logga in för att börja sälja.",
    signInBody: "Du kan se aktiva annonser utan konto. Logga in för att skapa och hantera dina egna domäner.",
    ...
    sellerLead: "Börja med ett tydligt pris och en kort text för köpare. Du kan begära domänkontroll direkt efter skapandet.",
    sellerName: "Publikt säljarname",
    sellerNameHint: "Visas på den publika annonsen.",
    domain: "Domännamn",
    price: "Begärt pris",
    currency: "Valuta",
    ...
    open: "Öppna annons",
    statusDraft: "Utkast",
    statusProof: "DNS-uppgift skapad — väntar på kontroll",
    statusChecking: "Kontrollerar DNS",
    statusLive: "Publicerad",
    statusPaused: "Pausad",
    statusWithdrawn: "Indragen",
    statusOther: "Behöver granskning",
    proofTitle: "Bevisa att du kontrollerar domänen",
    proofLead: "Lägg in exakt TXT-post nedan och låt sedan Sajda kontrollera den. DNS kan behöva lite tid för att spridas.",
    ...
    lineLabel: "Rad",
    bulkReady: "{count} annons(er) är klara att skapa.",
    ...
    offers: "Köparbud",
    offersLead: "Granska varje bud och välj om du vill fortsätta säljsamtalet.",
    ...
    offerAccepted: "Samtalet öppnat",
    offerDeclined: "Avböjt",
    acceptOffer: "Gå vidare med samtalet",
    declineOffer: "Avböj",
  ...
  es: {
    ...
    lead: "Crea un anuncio, demuestra el control con un registro DNS TXT y ofrece a cada anuncio activo una página Sajda directa y un sitio de venta descargable.",
    signInTitle: "Inicia sesión para empezar a vender.",
    signInBody: "Puedes explorar los anuncios activos sin cuenta. Inicia sesión para crear y gestionar tus dominios.",
    ...
    sellerLead: "Empieza con un precio claro y una breve descripción para compradores. Puedes solicitar el control del dominio justo después de crearlo.",
    ...
    proofLead: "Añade el registro TXT exacto y pide a Sajda que lo compruebe. El DNS puede tardar un momento en propagarse.",
    ...
    bulkErrors: "Corrige {count} problema(s) de fila antes de importar.",
    lineLabel: "Línea",
    bulkReady: "{count} anuncio(s) listos para crear.",
  ...
  fr: {
    ...
    lead: "Créez une annonce, prouvez le contrôle avec un enregistrement DNS TXT, puis donnez à chaque annonce active une page Sajda directe et un site de vente téléchargeable.",
    signInTitle: "Connectez-vous pour commencer à vendre.",
    signInBody: "Vous pouvez parcourir les annonces actives sans compte. Connectez-vous pour créer et gérer vos domaines.",
    ...
    sellerLead: "Commencez avec un prix clair et une courte description destinée à l’acheteur. Vous pourrez demander une preuve de contrôle juste après la création.",
    ...
    proofLead: "Ajoutez l’enregistrement TXT exact ci-dessous, puis demandez à Sajda de le vérifier. La propagation DNS peut prendre un moment.",
    ...
    bulkErrors: "Corrigez {count} erreur(s) de ligne avant l’importation.",
    lineLabel: "Ligne",
    bulkReady: "{count} annonce(s) prêtes à créer.",
  ...
  zh: {
    eyebrow: "卖家工作区",
    title: "发布您已经拥有的域名。",
    lead: "创建挂牌，通过一条 DNS TXT 记录证明控制权，然后为每个活跃挂牌提供直接 Sajda 页面和可下载的出售网站。",
    signInTitle: "登录后开始出售。",
    signInBody: "无需账户即可浏览活跃挂牌。登录后可创建和管理自己的域名。",
    signIn: "登录后出售",
    publicTitle: "活跃挂牌",
    ...
    statusWithdrawn: "已撤回",
    statusOther: "需要审核",
    proofTitle: "证明你控制这个域名",
    proofLead: "添加下方确切的 TXT 记录，然后让 Sajda 检查。DNS 传播可能需要一点时间。",
    ...
    bulkErrors: "导入前请修正 {count} 个行问题。",
    lineLabel: "行",
    bulkReady: "{count} 个挂牌已可创建。",
    import: "创建 {count} 个挂牌",
    importing: "正在创建挂牌…",
    ...
    offers: "买家出价",
    offersLead: "查看每一份出价，并决定是否继续出售沟通。",
