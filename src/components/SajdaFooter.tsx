...
const footerCopy: Record<Language, FooterCopy> = {
  en: {
    ...
    body: "Find domain ideas, check availability, compare offers, and save your favorites.",
    ...
    searchHint: "Find ideas and check domain availability",
    swipe: "Swipe",
    swipeHint: "Browse short checked names",
    marketplace: "Marketplace",
    marketplaceHint: "List a domain or explore offers",
    today: "Today’s 10",
    watchlist: "Saved domains",
    history: "Search history",
    domains: "My domains",
    signIn: "Sign in",
    signInHint: "Keep your saved domains in one account",
    ...
    madeFor: "A better name for your next idea.",
    apiDescription: "Read the current API contract",
    sourcesDescription: "Inspect source-labeled market facts",
  },
  sv: {
    label: "Sidfot för Sajda",
    title: "Hitta ett namn att bygga vidare på.",
    body: "Hitta domänförslag, kontrollera om de är lediga, jämför erbjudanden och spara dina favoriter.",
    live: "Sök, Swipe, marknadsplats och utvecklarverktyg",
    product: "Produkt",
    developer: "Utvecklare",
    company: "Företag & förtroende",
    legalTrust: "Juridik & förtroende",
    search: "Domänsökning",
    searchHint: "Få namnförslag och kontrollera domäner",
    swipe: "Swipe",
    swipeHint: "Bläddra bland korta kontrollerade namn",
    marketplace: "Marknadsplats",
    marketplaceHint: "Lägg ut en domän eller utforska objekt",
    today: "Dagens 10",
    watchlist: "Sparade domäner",
    history: "Sökhistorik",
    domains: "Mina domäner",
    signIn: "Logga in",
    signInHint: "Samla dina sparade domäner på ett konto",
    ...
    madeFor: "Ett bättre namn för din nästa idé.",
  ...
  es: {
    ...
    title: "Encuentra un nombre que destaque.",
    body: "Encuentra ideas de dominios, comprueba su disponibilidad, compara ofertas y guarda tus favoritos.",
    ...
    madeFor: "Un mejor nombre para tu próxima idea.",
  ...
  fr: {
    ...
    title: "Trouvez un nom qui se démarque.",
    body: "Trouvez des idées de domaines, vérifiez leur disponibilité, comparez les offres et enregistrez vos favoris.",
    ...
    searchHint: "Trouver des idées et vérifier des domaines",
    swipe: "Swipe",
    ...
    watchlist: "Domaines enregistrés",
    history: "Historique de recherche",
    domains: "Mes domaines",
    signIn: "Se connecter",
    signInHint: "Retrouver vos domaines enregistrés sur un seul compte",
    ...
    madeFor: "Un meilleur nom pour votre prochaine idée.",
  ...
  zh: {
    label: "Sajda 网站页脚",
    title: "找到让人记住的域名。",
    body: "获取域名灵感，查询是否可注册，比较报价，并保存心仪的域名。",
