...
const logoCopy = {
  en: {
    ...
    remaining: "{count} local beta {concept} remaining today",
    concept: "concept",
    concepts: "concepts",
    limitTitle: "Today’s local beta concepts are used",
  ...
  sv: {
    ...
    description: "En unik SVG-studie som skapas i den här webbläsaren utifrån domännamnet. Den är en startpunkt, inte varumärkesgranskning eller en färdig identitet.",
    localNote: "Skapas i din webbläsare. Ingen domändata skickas till en extern bildgenerator.",
    variation: "Ny variation",
    download: "Hämta SVG",
    remaining: "{count} lokala beta-{concept} kvar i dag",
    concept: "koncept",
    concepts: "koncept",
    limitTitle: "Dagens lokala beta-koncept är använda",
    limitDescription: "Den här webbläsaren sparar en liten daglig förhandsgräns. Ett redan skapat koncept går fortfarande att hämta.",
  ...
  es: {
    ...
    remaining: "Quedan {count} {concept} beta locales hoy",
    concept: "concepto",
    concepts: "conceptos",
    limitTitle: "Ya usaste los conceptos beta locales de hoy",
    limitDescription: "Este navegador conserva un pequeño límite diario de vistas previas. Aún puedes descargar un concepto ya creado.",
  ...
  fr: {
    ...
    remaining: "Il reste {count} {concept} bêta local{countPlural} aujourd’hui",
    concept: "concept",
    concepts: "concepts",
    limitTitle: "Les concepts bêta locaux du jour ont été utilisés",
    limitDescription: "Ce navigateur conserve une petite limite quotidienne d’aperçus. Un concept déjà créé reste téléchargeable.",
    style: "Direction : {style}",
  },
  zh: {
    action: "创建徽标概念",
    ...
    variation: "新变体",
    download: "下载 SVG",
    remaining: "今天还可生成 {count} 个本地测试版概念",
    concept: "概念",
    concepts: "概念",
