...
const copy: Record<Language, InspirationCopy> = {
  en: {
    ...
    contextualRouteLabel: "Shaped from your current search",
    genericRouteLabel: "A curated starting route",
    sourceLabel: "Current input",
    sourceBrief: "Brief",
    sourceSearch: "Search",
    sourceEmpty: "Add a theme or brief above to make the next route specific to your search.",
    sourceDescription: "These terms are carried into the search when you use this route.",
    extensionsLabel: "Extension check",
    extensionsEmpty: "Set extensions below",
    namingCues: "Naming cues",
    guardrail: "Keep it sharp",
    useDirection: "Use in search",
    newDirection: "Try another",
    reframing: "Reframing",
    reframingStatus: "Finding another route through your current input",
    directionChanged: "A new naming route is ready",
  },
  sv: {
    eyebrow: "Sajda-inspiration",
    contextualRouteLabel: "Formad av din aktuella sökning",
    genericRouteLabel: "Ett kurerat startspår",
    sourceLabel: "Aktuellt underlag",
    sourceBrief: "Beskrivning",
    sourceSearch: "Sökning",
    sourceEmpty: "Lägg till ett tema eller en beskrivning ovanför så blir nästa spår specifikt för din sökning.",
    sourceDescription: "De här orden följer med in i sökningen när du använder spåret.",
    extensionsLabel: "Ändelsekontroll",
    extensionsEmpty: "Välj ändelser nedan",
    namingCues: "Namnspår",
    guardrail: "Håll det vasst",
    useDirection: "Använd i sökning",
    newDirection: "Prova ett annat",
    reframing: "Formar om",
    reframingStatus: "Hittar ett annat spår utifrån ditt aktuella underlag",
    directionChanged: "Ett nytt namnspår är redo",
  },
  es: {
    eyebrow: "Inspiración Sajda",
    contextualRouteLabel: "Moldeada por tu búsqueda actual",
    genericRouteLabel: "Una ruta inicial seleccionada",
    sourceLabel: "Entrada actual",
    sourceBrief: "Descripción",
    sourceSearch: "Búsqueda",
    sourceEmpty: "Añade un tema o una descripción arriba para que la siguiente ruta sea específica para tu búsqueda.",
    sourceDescription: "Estos términos se incorporan a la búsqueda cuando usas esta ruta.",
    extensionsLabel: "Comprobación de extensión",
    extensionsEmpty: "Elige extensiones abajo",
    namingCues: "Pistas de nombre",
    guardrail: "Mantén la precisión",
    useDirection: "Usar en la búsqueda",
    newDirection: "Probar otra",
    reframing: "Replanteando",
    reframingStatus: "Buscando otra ruta a través de tu entrada actual",
    directionChanged: "Una nueva ruta de nombres está lista",
  },
  fr: {
    eyebrow: "Inspiration Sajda",
    contextualRouteLabel: "Façonnée par votre recherche actuelle",
    genericRouteLabel: "Une piste de départ sélectionnée",
    sourceLabel: "Saisie actuelle",
    sourceBrief: "Brief",
    sourceSearch: "Recherche",
    sourceEmpty: "Ajoutez un thème ou un brief ci-dessus pour que la prochaine piste soit propre à votre recherche.",
    sourceDescription: "Ces termes sont repris dans la recherche lorsque vous utilisez cette piste.",
    extensionsLabel: "Vérification d’extension",
    extensionsEmpty: "Choisissez des extensions ci-dessous",
    namingCues: "Signaux de nom",
    guardrail: "Gardez du relief",
    useDirection: "Utiliser dans la recherche",
    newDirection: "Essayer une autre",
    reframing: "Reformulation",
    reframingStatus: "Recherche d’une autre piste à partir de votre saisie actuelle",
    directionChanged: "Une nouvelle piste de nom est prête",
  },
  zh: {
    eyebrow: "Sajda 灵感",
    contextualRouteLabel: "根据当前搜索调整",
    genericRouteLabel: "精心挑选的起步方向",
    sourceLabel: "当前输入",
    sourceBrief: "说明",
    sourceSearch: "搜索",
    sourceEmpty: "在上方添加主题或说明，让下一条方向贴合你的搜索。",
    sourceDescription: "使用此方向时，这些词会带入搜索中。",
    extensionsLabel: "后缀核验",
    ...
    newDirection: "换一个试试",
    reframing: "调整方向",
    reframingStatus: "正根据当前输入寻找另一条方向",
    directionChanged: "新的命名方向已准备好",
  },
};
